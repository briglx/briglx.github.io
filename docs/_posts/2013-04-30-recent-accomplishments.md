...
- Wrote a [White Paper](http://briglamoreaux.com/talks/ "Talks") and presented the results at several conferences on how Apollo evaluated MongoDB.
- Wrote several articles explaining [ontologies]( {% post_url 2012-10-26-what-graphs-and-ontologies-mean-to-you %} "What Graphs and Ontologies mean to you") and cloud testing [best practices]({% post_url 2012-08-21-load-testing-aws %} "Load Testing with AWS").
