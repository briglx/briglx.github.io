...
|  `on.workflow_call.inputs`                                                                                                               | Input variables                    | HCI/Trigger      | Parameters passed to an action, resuable workflow, or manually triggered workflow. Parameters that change for each deployment. | `env`, `skip_coverage`, `release_type`, `profile`                              |
...
| Workflow - [Secrets](https://docs.github.com/en/actions/security-guides/using-secrets-in-github-actions)                                 | Global secure variable             | Automation Plane | Secure variable used between workflow jobs.                                                                                    |  tbd                                                                           |
